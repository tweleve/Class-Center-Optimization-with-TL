...
def build_model(cfg):
    ...
    if cfg.MODEL.PRETRAIN == "imagenet":
        ...
        # pretrained_path = '/home/hzj/Pycharms/xbm/configs/pth/resnet50.pth'
        # pretrained_path = '/home/hzj/Pycharms/xbm/tools/output/tripletLoss/best_model4.pths_sets'
        ...
        assert False, f"not imagenet pretrain and not exist model path: {cfg.MODEL.PRETRAIN}"
    return model
